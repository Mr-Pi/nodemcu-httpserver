...
SERVER_FILES := httpserver.lua httpserver-request.lua httpserver-basicauth.lua base64_v2.lua httpserver-static.lua httpserver-header.lua httpserver-error.lua wifi.lua init.new.lua $(wildcard http-init/*)
